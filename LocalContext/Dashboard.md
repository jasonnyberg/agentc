...
**Next Action**: Continue 🔗[G110](./Knowledge/Goals/G110-EventfdEpollMicroVmIpcDesign/index.md) by deciding the G091 async-intern integration shape and abandoned-resource recovery policy. Then continue 🔗[G091](./Knowledge/Goals/G091-InternWorkerConcurrencyMvp/index.md) with broker-compatible `intern_start!` / `intern_sync!`; treat 🔗[G109](./Knowledge/Goals/G109-ListreeReadOnlyMutationSurfaceHardening/index.md) as the immediate safety companion before trusting shared read-only worker context.
