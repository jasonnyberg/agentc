...
1. **Unblock Full `edict_tests`**: Investigate `CallbackTest.EdictCliImportResolvedDemoPrintsExpectedResult` / the underlying `edict -e ...` hang, then rerun the full standalone suite.
