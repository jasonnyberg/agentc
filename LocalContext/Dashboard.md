...
- [x] Created/updated G084, G085, G086, and G087 goal files
- [x] Implemented VM/compiler cleanup, VM translation-unit split, live Google/Gemma test coverage, and adjacent-eval documentation/script style update
