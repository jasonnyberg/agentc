...
**Active Task**: Continue G049 follow-through after completing G050. The thread-runtime path now verifies cleanly in focused repeats, standalone `edict_tests`, and full `ctest`; the remaining work returns to broader G049 follow-through and documentation/validation.
