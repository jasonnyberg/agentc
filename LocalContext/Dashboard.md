...
2. 🔗[G110 — Root1 eventfd/epoll Resource Broker and Micro-VM IPC Design](./Knowledge/Goals/G110-EventfdEpollMicroVmIpcDesign/index.md) — **ACTIVE**; first Linux prototype landed with participant eventfds, Root1 epoll polling, resource keys, ownership-requested flags, wait queues, grant tokens, and mailbox descriptors; next is mmap coordination slab/ring shape plus fd reconstruction/owner-death semantics.
