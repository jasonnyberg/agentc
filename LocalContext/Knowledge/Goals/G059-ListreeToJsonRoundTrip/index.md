...
3. **Round-Trip Tests**: Created a robust suite of round-trip tests in `listree/listree_tests.cpp` covering nested lists/maps, recursive structures, and binary data.
