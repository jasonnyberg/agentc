...
- [x] Ensure cognitive control flow is 100% Edict-owned. FFI methods act strictly as isolated tools/actuators, not orchestrators. (Tree initialization boilerplate remains in safe C++ Listree API, but no cognitive execution happens outside the VM).
