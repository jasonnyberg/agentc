...
Remaining G091 hardening before closure: decide whether explicit worker arena/slab lifecycle cleanup is required and execute/coordinate 🔗[G111 — Root1/Worker Primitive FFI and Edict Intern Surface Migration](../G111-Root1WorkerPrimitiveFfiEdictInternMigration/index.md), which moves the remaining intern-specific opcode behavior behind importable Root1/worker primitives and plain Edict words. Then promote 🔗[G099 — Intern Task Quality Contracts](../G099-InternTaskQualityContracts/index.md) with the now-concrete event/backpressure/cancel fields.
