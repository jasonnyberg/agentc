...
- [x] Add first `ListreeStaticMountRegistry` with explicit logical mount ids, root id lookup, root handle access, active status, and unmount release through `ListreeStaticMountLease`.
